  ...
  render() {
    ...
    return (<section className="faq">
        <div className="row">
            ...
            <div className="col-12 col-md-6 px-0 row">
            {
                questions.map((question, i) => {
                return <div className="question_tab col-md-12 pl-0" key={i} 
                onClick={this.handleClick.bind(this, i, this.props)}>
                    <div className={question.index===particular_ques.index?'question active':'question'}>
                        {question.ques}
                    </div>
                    <div className="answer" hidden={question.index!==particular_ques.index}>
            ...
            <div className="col-12 col-md-6 px-0 row">
            {
                ...
                return <div className="question_tab col-md-12 pl-0" key={i} 
                onClick={this.handleClick.bind(this, question.index, this.props)}>
                    <div className={question.index===particular_ques.index?'question active':'question'}>
                        {question.ques}
                    </div>
                    <div className="answer" hidden={question.index!==particular_ques.index}>
                        <div className="answer_text" dangerouslySetInnerHTML={{ __html:question.ans}} />
                    </div>
                    <div className="faq_line" />
                </div>;
            }, this )
