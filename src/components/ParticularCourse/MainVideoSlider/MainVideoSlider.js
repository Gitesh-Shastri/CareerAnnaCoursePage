      ...
      <div className="heading_small_inside">
        ...
        <div className="line_small"/>
          ...
          <button 
                ...
                disabled={video_item.index===0}><i className='fa fa-angle-left'></i>
              </button>
              </div>
          <div className="px-0 col-12 video_player_list">
            <div className="video_playlist" style={{
			...
			}}>
              {
                ...
                <div key={i} onMouseEnter={() => this.clearIntervalMouse()} onMouseLeave={() => this.startIntervalMouse()} onClick={()=> this.showModal(i)}>
        ...
        ><i className='fa fa-angle-right'></i></button>
          ...
          <button 
                ...
                hidden={video_item.index===0}><i className='fa fa-caret-left'></i>
              </button>
          <button 
        ...
        ><i className='fa fa-caret-right'></i></button>     
          </div>
      </div>
      </div>
    );
